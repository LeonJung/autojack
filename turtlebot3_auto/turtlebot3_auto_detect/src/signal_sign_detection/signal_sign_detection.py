...
class TrafficSignDetection():
    def __init__(self):
        ...
        self.saver.restore(self.sess, "/home/leon/catkin_ws/src/autojack/turtlebot3_auto/turtlebot3_auto_detect/src/signal_sign_detection/model/model.ckpt")

        self.selecting_sub_image = "raw" # you can choose image type "compressed", "raw"
        # subscribers
        if self.selecting_sub_image == "compressed":
            self._sub = rospy.Subscriber('/camera/image_compensated/compressed', CompressedImage, self.callback, queue_size=1)
        else:
            self._sub = rospy.Subscriber('/camera/image_compensated', Image, self.callback, queue_size=1)
